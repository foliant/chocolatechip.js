...
`<div class="choc-banner choc-padding--tiny" style="display: flex;">
    <div class="choc-display--sm-none choc-padding--small" style="width:100%; text-align: right;"><img width="70" src="/img/cookie-logo.jpg"></div>
    <p>
      <span style="font-weight: 700">Cookies</span><br />
      ${translations["bannerTemplate.text"]}

      <a href="#" class="choc-display--none choc-display--sm-inline-block choc-btn--type-secondary" data-choc-action="presentModal">${translations["bannerTemplate.actionOpen"]}</a>
      <span class="choc-banner__description">
        ${translations["bannerTemplate.description"]}
        <a href="#" class="choc-btn--type-secondary" data-choc-action="presentModal">${translations["bannerTemplate.actionOpen"]}</a>
      </span>
      <br /><br />
      <a href="#" class="choc-btn" data-choc-action="acceptAllCookies">${translations["bannerTemplate.actionSluiten"]}</a>
    </p>
    <div class="choc-display--sm-none" style="width:50%;"></div>
  </div>`;
