export default {
  nl_NL: {
    'bannerTemplate.text': 'Leuk dat je onze website bezoekt. Door verder te klikken op onze website, accepteer je cookies en vergelijkbare technieken.',
    ...
    'bannerTemplate.actionOpen': 'Meer informatie',
